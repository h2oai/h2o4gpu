function [x, y, factors, n_iter] = h2ogpuml(prox_f, prox_g, obj_fn, A, params, factors)
...
%
%   [x, factors] = h2ogpuml(prox_f, prox_g, obj_fn, A)
%   [x, factors] = h2ogpuml(prox_f, prox_g, obj_fn, A, params, factors)
% 
