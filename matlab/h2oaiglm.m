function [x, y, factors, n_iter] = h2oaiglm(prox_f, prox_g, obj_fn, A, params, factors)
...
%
%   [x, factors] = h2oaiglm(prox_f, prox_g, obj_fn, A)
%   [x, factors] = h2oaiglm(prox_f, prox_g, obj_fn, A, params, factors)
% 
