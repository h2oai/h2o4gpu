...
dotest:
	...
	mkdir -p ./tmp/
  # can't do -n auto due to limits on GPU memory
	$(PYTHON) -m pytest -s --verbose --durations=10 --numprocesses 5 --timeout=1200 --fulltrace --full-trace --junit-xml=build/test-reports/h2o4gpu-test.xml tests/python/open_data 2> ./tmp/h2o4gpu-test.$(LOGEXT).log
	$(PYTHON) -m pytest -s --verbose --durations=10 --numprocesses 4 --timeout=1200 --fulltrace --full-trace --junit-xml=build/test-reports/h2o4gpu-test.xml tests/python/open_data 2> ./tmp/h2o4gpu-test.$(LOGEXT).log
	$(PYTHON) -m pytest -s --verbose --durations=10 --numprocesses 3 --timeout=1200 --fulltrace --full-trace --junit-xml=build/test-reports/h2o4gpu-test.xml tests/python/open_data 2> ./tmp/h2o4gpu-test.$(LOGEXT).log
	$(PYTHON) -m pytest -s --verbose --durations=10 --numprocesses 2 --timeout=1200 --fulltrace --full-trace --junit-xml=build/test-reports/h2o4gpu-test.xml tests/python/open_data 2> ./tmp/h2o4gpu-test.$(LOGEXT).log
