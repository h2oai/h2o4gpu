...
cat src/interface_py/h2o4gpu/__init__.base.py src/interface_py/build_info.txt src/interface_py/h2o4gpu/__init__.py.2 > src/interface_py/h2o4gpu/__init__.py
