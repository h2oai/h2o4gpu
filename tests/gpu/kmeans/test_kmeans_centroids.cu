...
TEST(KMeansCentroids, CalculateCentroids2GPU2) {
  // GIVEN
  int k = 2;
  int d = 2;
  int n = 3;
  ...
  // Setup data for "gpu2"
  dataHost[0] = 4.0f; dataHost[1] = 4.0f; // [1,1]
  dataHost[2] = 1.0f; dataHost[3] = 4.0f; // [1,1]
  dataHost[4] = 1.0f; dataHost[5] = 2.0f; // [1,1]
  labelsHost[0] = 0;
  labelsHost[1] = 1;
  labelsHost[2] = 1;
  indicesDevice = indicesHost;
  ...
  printf("%g ", (finalCentroidsHost.data()[0] + centroidsHost.data()[0])/2.0f);
  printf("%g ", (finalCentroidsHost.data()[1] + centroidsHost.data()[1])/2.0f);
  printf("%g ", (finalCentroidsHost.data()[2] + centroidsHost.data()[2])/2.0f);
  printf("%g ", (finalCentroidsHost.data()[3] + centroidsHost.data()[3])/2.0f);
