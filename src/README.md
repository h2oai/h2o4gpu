## C++ Implementation of H2O4GPU

Tutorial
--------
Please refer to the examples to see how to use H2O4GPU. Documentation will be updated in the near future.
...
Examples
--------
See the `<h2o4gpu>/examples/cpp/` directory for examples of how to use the solver. We have included six classes of problems:
