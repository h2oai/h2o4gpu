...
cublasStatus_t blas_gemm(cublasHandle_t handle, cublasOperation_t transa,
                         ...
                         const matrix<T> *A, const matrix<T> *B, const T beta,
                         matrix<T> *C);
...
cublasStatus_t blas_gemm(cublasHandle_t handle, cublasOperation_t transa,
  ...
  cublasStatus_t err = cublasSgemm(handle, transa, transb,
      static_cast<int>(C->size1), static_cast<int>(C->size2), k, &alpha,
      A->data, static_cast<int>(A->tda), B->data, static_cast<int>(B->tda),
...
cublasStatus_t blas_gemm(cublasHandle_t handle, cublasOperation_t transa,
  ...
  int k = transa == CUBLAS_OP_N ? A->size2 : A->size1;
  cublasStatus_t err = cublasDgemm(handle, transa, transb,
      static_cast<int>(C->size1), static_cast<int>(C->size2), k, &alpha,
      A->data, static_cast<int>(A->tda), B->data, static_cast<int>(B->tda),
      &beta, C->data, static_cast<int>(C->tda));
  CublasCheckError(err);
