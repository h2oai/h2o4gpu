...
#'
#'@param data_path Path to data that needs to be preprocessed for h2o4gpu
#'@param response Response column as a string
#'@param output_csv_name Name of saved csv file
#'@export
prep_data <- function(data_path="", response="", output_csv_name="data.csv"){
  wd <- getwd()
