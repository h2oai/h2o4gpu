...
cd ../
R CMD INSTALL --build h2o4gpu

R
install.packages("h2o4gpu.0_R_x86_64-pc-linux-gnu.tar.gz", repos = NULL, type="source")
# installs in ~/R/x86_64-pc-linux-gnu-library/3.3/h2o4gpu/ (assumes overwrites system's libraries)
