...
#define F77_xerbla  XERBLA
   ...
   #define F77_izamax_sub IZAMAX
   #define F77_sdot_sub   SDOT
   #define F77_ddot_sub   DDOT
   #define F77_dsdot_sub   DSDOT
   ...
   #define F77_cdotu_sub  CDOTU
   #define F77_cdotc_sub  CDOTC
   #define F77_zdotu_sub  ZDOTU
   #define F77_zdotc_sub  ZDOTC
   #define F77_snrm2_sub  SNRM2
   #define F77_sasum_sub  SASUM
   #define F77_dnrm2_sub  DNRM2
   #define F77_dasum_sub  DASUM
   #define F77_scnrm2_sub  SCNRM2
   #define F77_scasum_sub  SCASUM
   #define F77_dznrm2_sub  DZNRM2
   #define F77_dzasum_sub  DZASUM
   #define F77_sdsdot_sub   SDSDOT
/*
 * Level 2 BLAS
 */
