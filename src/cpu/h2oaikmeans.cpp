...
#include "h2oaikmeans_kmeanscpu.h"
...
namespace h2oaikmeans {
    ...
    template <typename T>
    H2OAIKMeansCPU<T>::H2OAIKMeansCPU(const T* A, int k, int n, int d)
    {
      _A = A; _k = k; _n = n; _d = d;
    }
...
// Explicit template instantiation.
  ...
  template class H2OAIKMeansCPU<double>;
#endif

#if !defined(H2OAIGLM_SINGLE) || H2OAIGLM_SINGLE==1
  template class H2OAIKMeansCPU<float>;
#endif
...
extern "C" {
  ...
  int make_ptr_float_kmeans(int cpu_id, int n_cpu, size_t mTrain, size_t n, const char ord, int k, int max_iterations, int init_from_labels, int init_labels, int init_data, float threshold, const float* srcdata, const int* srclabels, void** res) {
    return h2oaikmeans::makePtr_dense<float>(cpu_id, n_cpu, mTrain, n, ord, k, max_iterations, init_from_labels, init_labels, init_data, threshold, srcdata, srclabels, res);
}
  int make_ptr_double_kmeans(int cpu_id, int n_cpu, size_t mTrain, size_t n, const char ord, int k, int max_iterations, int init_from_labels, int init_labels, int init_data, double threshold, const double* srcdata, const int* srclabels, void** res) {
    return h2oaikmeans::makePtr_dense<double>(cpu_id, n_cpu, mTrain, n, ord, k, max_iterations, init_from_labels, init_labels, init_data, threshold, srcdata, srclabels, res);
  }
