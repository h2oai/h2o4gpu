%%H2OAIGLM Generic graph projection splitting solver.
...
%               of structs, then H2OAIGLM will solve each each problem in
%               succession (this will be much faster than solving the
%               problems individually, since H2OAIGLM will perform
...
%
%   References: 
%   http://foges.github.io/h2oaiglm
%     Documentation for H2OAIGLM -- C. Fougner
%
