%%H2OGPUML Generic graph projection splitting solver.
...
%               of structs, then H2OGPUML will solve each each problem in
%               succession (this will be much faster than solving the
%               problems individually, since H2OGPUML will perform
...
%
%   References: 
%   http://foges.github.io/h2ogpuml
%     Documentation for H2OGPUML -- C. Fougner
%
