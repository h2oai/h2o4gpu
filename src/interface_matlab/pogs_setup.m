...
%                 'make pogs_sp_cu.o -f ../Makefile -C .. IFLAGS="-D__MEX__";' ...
%                 'make pogs_sp_cu_link.o -f ../Makefile -C .. IFLAGS="-D__MEX__;"'], ...
%                cuda_bin, cuda_lib));
  unix(sprintf(['export PATH=$PATH:%s;' ...
                'export DYLD_LIBRARY_PATH=%s:$DYLD_LIBRARY_PATH;' ...
               ...
               cuda_bin, cuda_lib));
  try
    eval(sprintf(['mex -largeArrayDims -I.. -L%s -lcudart -lcublas -lcusparse -output pogs ' ...
