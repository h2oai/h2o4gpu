function h2ogpuml_setup(varargin)
%% Setup script for h2ogpuml
...
if ~opt_gpu
  ...
  eval(sprintf(['mex -largeArrayDims -I../include ' ...
                ...
                'LDFLAGS=''\\$LDFLAGS %s'' ' ...
                'h2ogpuml_mex.cpp blas2cblas.cpp ../build/h2ogpuml.a -lmwblas  ' ...
                '-output h2ogpuml'], omp_flag, omp_flag))
else
  unix('make clean -C ..');
