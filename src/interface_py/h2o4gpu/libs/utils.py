...
def load_kmeans_lib(lib_path):
    try:
        ...
        # Fit and Predict
        h2o4gpu_kmeans_lib.make_ptr_float_kmeans.argtypes = [c_int, c_int,
                                                              c_int, c_int,
                                                              c_int,
                                                              c_size_t,
                                                              c_size_t,
        ...
        h2o4gpu_kmeans_lib.make_ptr_double_kmeans.argtypes = [c_int, c_int,
                                                               c_int, c_int,
                                                               c_int,
                                                               c_size_t,
                                                               c_size_t,
        ...
        print(
            '\nWarning: h2o4gpu_kmeans_lib shared object (dynamic library) %s failed to load.'
            % lib_path)
