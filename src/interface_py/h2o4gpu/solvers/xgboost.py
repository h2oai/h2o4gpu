...
class RandomForestClassifier(xgb):
    def __init__(self, n_estimators=10,
        ...
        pass
        # TODO: num_parallel_tree = 100, subsample = 0.5, colsample_bytree =0.5, nrounds = 1,


class RandomForestRegressor(xgb):
...
class GradientBoostingClassifier(xgb):
...
class GradientBoostingRegressor(xgb):
