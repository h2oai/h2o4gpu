...
class KMeansGPU2():
    ...
    def fit(self, X):
        ...
        import \
            libKMCUDA  ## git clone http://github.com/h2ogpuml/kmcuda/ ; cd kmcuda/src ; cmake -DCMAKE_BUILD_TYPE=Release . ; export CUDA_TOOLKIT_ROOT_DIR=$CUDA_HOME ; python setup.py sdist bdist_wheel ; pip install dist/libKMCUDA-6.2.0-cp36-cp36m-linux_x86_64.whl --upgrade
