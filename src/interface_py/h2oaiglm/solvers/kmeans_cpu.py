...
if not h2oaiKMeansCPU:
    ...
    class KMeansSolverCPU(object):
        def __init__(self, cpu_id, n_cpus, k, max_iterations, threshold, init_from_labels, init_labels, init_data, **params):
            self.solver = KMeansBaseSolver(cpu_id, n_cpus, k, max_iterations, threshold, init_from_labels, init_labels, init_data, params)
