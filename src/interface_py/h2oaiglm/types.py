...
STATUS = {}
STATUS[0]='H2OAIGLM_SUCCESS'
STATUS[1]='H2OAIGLM_INFEASIBLE'
STATUS[2]='H2OAIGLM_UNBOUNDED'
STATUS[3]='H2OAIGLM_MAX_ITER'
STATUS[4]='H2OAIGLM_NAN_FOUND'
STATUS[5]='H2OAIGLM_ERROR'

# Default H2OAIGLM solver settings
DEFAULTS = {}
