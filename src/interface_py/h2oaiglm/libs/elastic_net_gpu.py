...
try:
	...
	h2oaiglmElasticNetGPU.make_ptr_double.argtypes = [c_int, c_int, c_int, c_size_t, c_size_t, c_size_t,
	...
	h2oaiglmElasticNetGPU.make_ptr_float.argtypes = [c_int, c_int, c_int, c_size_t, c_size_t, c_size_t,
