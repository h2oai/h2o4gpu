...
try:
	...
	pogsElasticNetGPU.make_ptr_double.argtypes = [c_int, c_size_t, c_size_t, c_size_t, c_double_p, c_double_p, c_double_p, c_double_p, c_void_pp, c_void_pp, c_void_pp, c_void_pp]
	pogsElasticNetGPU.make_ptr_double.restype = c_int

	pogsElasticNetGPU.make_ptr_float.argtypes = [c_int, c_size_t, c_size_t, c_size_t, c_float_p, c_float_p, c_float_p, c_float_p, c_void_pp, c_void_pp, c_void_pp, c_void_pp]
