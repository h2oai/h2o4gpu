...
if not pogsElasticNetCPU:
	...
	class ElasticNetSolverCPU(object):
		def __init__(self, nThreads, nCPUs, ord, intercept, standardize, lambda_min_ratio, n_lambdas, n_alphas, double_precision):
			self.solver = ElasticNetBaseSolver(pogsElasticNetCPU, nThreads, nCPUs, ord, intercept, standardize, lambda_min_ratio, n_lambdas, n_alphas, double_precision)
